...
def arp_scan(network_prefix, ifname):
    ...
    # 获取本机IP地址
    localip = "17.88.21.226"
    # 获取本地MAC地址
    localmac = "c4:41:1e:74:e3:a4"
    ...
    result_raw = srp(Ether(src=localmac, dst='FF:FF:FF:FF:FF:FF') / ARP(op=1, hwsrc=localmac, hwdst='00:00:00:00:00:00',
                                                                        psrc=localip, pdst=ip_list), iface=ifname,
